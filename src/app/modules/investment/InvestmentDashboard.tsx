...
const InvestmentDashboard = () => {
  ...
  const onDashBoardClick = (status: string, statusType?: string) => {
    setShowDashBoard(false)
    if (statusType) {
      setUrl(
        `${API.PROSPECTS}/user/${currentUser?.id}/${role}/sales/status/${status}?statusType=${statusType}`
      )
      getRecords(
        `${API.PROSPECTS}/user/${currentUser?.id}/${role}/sales/status/${status}?statusType=${statusType}`,
        setProspects
      ...
      setUrl(`${API.PROSPECTS}/user/${currentUser?.id}/${role}/sales/status/${status}`)
      getRecords(
        `${API.PROSPECTS}/user/${currentUser?.id}/${role}/sales/status/${status}`,
        setProspects
      )
    }
  }
  ...
  return (
    <>
      ...
      <div hidden={showForm === true || !showDashBoard}>
              ...
              <div className=' position-relative'>
                <div className='row g-3 g-lg-6'>
                  <DashboardCards
                    ...
                    title='Assigned'
                    link={() => {
                      onDashBoardClick('1', 'operational')
                    }}
                    colSize={true}
                    color={'cyan'}
                  />
                  ...
                  <DashboardCards
                    ...
                    title='In Progress'
                    link={() => {
                      onDashBoardClick('2', 'operational')
                    }}
                    colSize={true}
                    color={'yellow'}
                  />
                  <DashboardCards
                    ...
                    link={() => {
                      onDashBoardClick('3', 'operational')
                    }}
                    colSize={true}
                    color={'yellow'}
                  />
                  <DashboardCards
                    ...
                    link={() => {
                      onDashBoardClick('4', 'operational')
                    }}
                    colSize={true}
                    color={'yellow'}
                  />
                  <DashboardCards
                    ...
                    link={() => {
                      onDashBoardClick('5', 'operational')
                    }}
                    colSize={true}
                    color={'yellow'}
                  />
                  ...
                  <DashboardCards
                    ...
                    srNo={count?.data?.['Verification of Online Form'] ?? '0'}
                    title='Verification of Online Form'
                    link={() => {
                      onDashBoardClick('9', 'product')
                    }}
                    colSize={true}
                    color={'grape'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['Sent to Product'] ?? '0'}
                    title='Sent To Product'
                    link={() => {
                      onDashBoardClick('10', 'product')
                    }}
                    colSize={true}
                    color={'grape'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['KYC Hold'] ?? '0'}
                    title='KYC Held'
                    link={() => {
                      onDashBoardClick('11', 'product')
                    }}
                    colSize={true}
                    color={'grape'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['E-Signed'] ?? '0'}
                    title='E-Signed'
                    link={() => {
                      onDashBoardClick('12', 'product')
                    }}
                    colSize={true}
                    color={'teal'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['Fees Received'] ?? '0'}
                    title='Fees Received'
                    link={() => {
                      onDashBoardClick('13', 'product')
                    }}
                    colSize={true}
                    color={'teal'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['Fees Invoice Sent'] ?? '0'}
                    title='Fees Invoice Sent'
                    link={() => {
                      onDashBoardClick('14', 'product')
                    }}
                    colSize={true}
                    color={'teal'}
                  />
                  <DashboardCards
                    ...
                    srNo={count?.data?.['Contract Note Updated'] ?? '0'}
                    title='Contract Note Updated'
                    link={() => {
                      onDashBoardClick('15', 'product')
                    }}
                    colSize={true}
                    color={'teal'}
                  />
      ...
      <div className='col-12 ' hidden={showForm || showDashBoard}>
        <CustomTable
          data={prospects}
